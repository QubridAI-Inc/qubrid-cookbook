...
| [Image Restoration Agent](./Agents/Image_Restoration_Agent)                                                                           | AI agent for image restoration and enhancement.                                                                                                                             |
...
| [Pro AI Image Creator](./LLMs/pro_ai_image_creator)                                                                                   | Professional AI image generation application.                                                                                                                               |
| **👁️ Multimodal AI**                                                                                                                  |                                                                                                                                                                             |
...
| [Whisper Large GPT OSS](./Multimodal/whisper_large_gpt_oss)                                                                           | Audio processing and transcription using Whisper Large.                                                                                                                     |
| **📓 Notebooks**                                                                                                                      |                                                                                                                                                                             |
